...
/**
 * AppUserRelationServiceImpl
 *
 * @author Paulson
 * @date 2020/2/11 23:38
 */
...
public class AppUserRelationServiceImpl implements AppUserRelationService {
    ...
    private ResponseResult followCancelByUserId(ApUser user, Integer followId) {
        ...
        if (apUserFollow == null){
            ...
            int cout = apUserFollowMapper.deleteByFollowId(BurstUtils.groudOne(user.getId()), user.getId(), followId);
            return ResponseResult.okResult(cout);
        }
    }
}
