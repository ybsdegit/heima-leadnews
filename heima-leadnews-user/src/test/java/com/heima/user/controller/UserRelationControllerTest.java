...
public class UserRelationControllerTest {
    ...
    MockMvc mvc;
    @Autowired
    ObjectMapper mapper; //content(JSON.toJSONString(dto));
...
//        builder.contentType(MediaType.APPLICATION_JSON_VALUE).content(mapper.writeValueAsBytes(dto));
        builder.contentType(MediaType.APPLICATION_JSON_VALUE).content(JSON.toJSONString(dto));
